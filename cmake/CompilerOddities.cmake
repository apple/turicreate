...
macro(Set_Compiler_Specific_Flags)
  ...
  if(COMPILER_HAS_IOS_BASE_FAILURE_WITH_ERROR_CODE)
    ...
    message(
      STATUS "Compiler does not support ios_base::failure(str, error_code)")
  endif()
  ...
  if(NOT COMPILER_HAS_NOEXCEPT_WHAT_ON_EXCEPTIONS_V1
    ...
    message(
      FATAL_ERROR
        "Cannot determine noexcept fladg on std::ios_base::failure.  See log.")
  ...
  elseif(COMPILER_HAS_NOEXCEPT_WHAT_ON_EXCEPTIONS_V2)
    add_compiler_source_define(COMPILER_MODIFIER_ON_EXCEPTION_WHAT=_NOEXCEPT)
  else()
