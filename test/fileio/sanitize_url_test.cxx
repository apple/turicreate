...
struct sanitize_url_test {
 public:
  void test_sanitize_url(void) {
    TS_ASSERT_EQUALS(sanitize_url("http://www.google.com"),
                     "http://www.google.com");
    TS_ASSERT_EQUALS(sanitize_url("file://www.google.com"),
                     "file://www.google.com");
    TS_ASSERT_EQUALS(sanitize_url("hdfs://hello:world@www.google.com"),
    ...
    TS_ASSERT_EQUALS(sanitize_url("s3://a/a:bb:cc:s3.amazonaws.com/pika/chu"),
                     "s3://s3.amazonaws.com/pika/chu");
    TS_ASSERT_EQUALS(sanitize_url("s3://a/a:b/b:cc:pika/chu"), "s3://pika/chu");
    TS_ASSERT_EQUALS(sanitize_url("s3://a/a:b/b:cc:s3.amazonaws.com/pika/chu"),
                     "s3://s3.amazonaws.com/pika/chu");
    TS_ASSERT_EQUALS(sanitize_url("s3://:pika/chu"), "s3://pika/chu");
    TS_ASSERT_EQUALS(sanitize_url("s3://:s3.amazonaws.com/pika/chu"),
                     "s3://s3.amazonaws.com/pika/chu");
    TS_ASSERT_EQUALS(sanitize_url("s3://:::pika/chu"), "s3://pika/chu");
    TS_ASSERT_EQUALS(sanitize_url("s3://:::s3.amazonaws.com/pika/chu"),
                     "s3://s3.amazonaws.com/pika/chu");
