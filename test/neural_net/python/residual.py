...
for key in param_keys:
    ...
    if len(weight.shape) == 4:
        residual_weight_dict[key] = weight.transpose(0, 2, 3, 1)
    else:
...
json_weights = {
    ...
    "residual_inst_1_beta" : residual_weight_dict["residualblock0_instancenorm0_beta"].flatten().tolist(),
    "residual_inst_1_gamma" : residual_weight_dict["residualblock0_instancenorm0_gamma"].flatten().tolist(),
    "residual_inst_2_beta" : residual_weight_dict["residualblock0_instancenorm1_beta"].flatten().tolist(),
    "residual_inst_2_gamma" : residual_weight_dict["residualblock0_instancenorm1_gamma"].flatten().tolist()
}
...
with open('data/residual/test_1/outputs.json', 'w') as fp:
    json.dump(json_outputs, fp)

with open('data/residual/test_1/inputs.json', 'w') as fp:
