...
######  <a name="linregr-model-access">Accessing attributes of the model</a>
...
###### <a name="linregr-interpreting-results">Interpreting results</a> 
...
###### <a name="linregr-stderr"> Standard-errors</a>
...
######  <a name="linregr-categorical-features">Categorical features</a> 
...
######  <a name="linregr-sparse-features"> Sparse features</a>
...
######  <a name="linregr-list-features"> List features</a>
...
######  <a name="linregr-feature-rescaling"> Feature rescaling</a>
...
######  <a name="linregr-solver"> Choosing the solver</a>
...
######  <a name="linregr-regularizer"> Regularizing Models (Lasso, Ridge, and Elastic Net regression)</a>
