...
if (CLANG)
  ...
  if (APPLE)
    ...
    SET(tmp2 "\"-stdlib=libc++ -rtlib=compiler-rt -lunwind\"")
  endif()
  if(TC_BUILD_IOS)
...
if (WIN32 AND ${MINGW_MAKEFILES})
  ...
  SET(BOOST_INSTALL_COMMAND "PATH=$PATH:${CMAKE_SOURCE_DIR}/deps/local/bin ./b2 -d0 -q ${ADD_BOOST_COMPILE_TOOLCHAIN} tools/bcp && cp dist/bin/bcp ${CMAKE_SOURCE_DIR}/deps/local/bin")
