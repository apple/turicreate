...
outputFeatureChannels:(int)outputFeatureChannels
  ...
  mWeightMomentumBuffer = 
      [dev newBufferWithLength:sizeof(float) * mInputFeatureChannels * mKernelHeight * mKernelWidth * mOutputFeatureChannels
                       options:storageMode];

  mWeightVelocityBuffer = 
      [dev newBufferWithLength:sizeof(float) * mInputFeatureChannels * mKernelHeight * mKernelWidth * mOutputFeatureChannels
                       options:storageMode];

  MPSVectorDescriptor *vDescWeights = 
      [MPSVectorDescriptor vectorDescriptorWithLength:mInputFeatureChannels * mKernelHeight * mKernelWidth * mOutputFeatureChannels
