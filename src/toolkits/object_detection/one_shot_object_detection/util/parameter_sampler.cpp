...
ParameterSampler::ParameterSampler( size_t width,
                                    size_t height,
                                    size_t dx,
                                    size_t dy)
 ...
 */
double ParameterSampler::get_theta() {
  return deg_to_rad(theta_);
}

double ParameterSampler::get_phi() {
  return deg_to_rad(phi_);
}

double ParameterSampler::get_gamma() {
  return deg_to_rad(gamma_);
}

size_t ParameterSampler::get_dz() {
  return dz_;
}

double ParameterSampler::get_focal() {
  return focal_;
}
