...
std::unique_ptr<model_spec> object_detector::init_darknet_yolo() const {
  ...
  const std::map<int, int> idx_channels = {{1, 32}, {2,64}, {3, 128}, {4, 256}, {5,512}, {6, 1024}};
  for (auto const& x : idx_channels)
  {
