...
REGISTER_NAMED_FUNCTION("_activity_classifier_random_split_by_session", activity_classifier::random_split_by_session, "data","session_id_column_name", "fraction", "seed");
REGISTER_DOCSTRING(
