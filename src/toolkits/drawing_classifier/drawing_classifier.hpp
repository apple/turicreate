...
class EXPORT drawing_classifier: public ml_model_base {
 ...
 public:
  ...
  REGISTER_CLASS_MEMBER_DOCSTRING(
      ...
      "    by default which uses a model trained on 245 of the 345 classes\n"
      "    in the Quick, Draw! dataset.\n"
      "    To disable warm start, pass in None to this\n"
      "    argument. Here is a list of all the pretrained models that\n"
      "    can be passed in as this argument:\n"
      "    \"auto\": Uses quickdraw_245_v0\n"
      "    \"quickdraw_245_v0\": Uses a model trained on 245 of\n"
      "                          the 345 classes in the Quick, Draw! dataset.\n"
      "    None: No Warm Start\n"
      "\n"
      "options : dict\n"
      "\n"
