...
variant_type linear_svm_scaled_logistic_opt_interface::get_validation_accuracy() {
...
variant_type linear_svm_scaled_logistic_opt_interface::get_training_accuracy() {
