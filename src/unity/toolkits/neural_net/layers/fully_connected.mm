...
- (id _Nonnull)initWithParams:(NSString *_Nonnull)name
  ...
  @autoreleasepool {
    ...
    mFullyConnectedDataLoad =
        [[FullyConnectedDataLoader alloc] initWithParams:mName
    ...
    mFullyConnectedNode =
        [MPSCNNFullyConnectedNode nodeWithSource:mInputNode
                                         weights:mFullyConnectedDataLoad];
    return self;
  }
}
