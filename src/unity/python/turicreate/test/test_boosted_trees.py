...
class BoostedTreesRegressionTest(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.model = tc.boosted_trees_regression.create(self.dtrain,
                                             target=self.target,
    ...
    def test_create(self):
        model =tc.boosted_trees_regression.create(self.dtrain, target='label',
                                        validation_set=self.dtest,
                                        **self.param)
        ...
        self.assertRaises(ToolkitError,
                          lambda:tc.boosted_trees_regression.create(self.dtrain,
    ...
    def test_predict_new_category(self):
        ...
        model =tc.boosted_trees_regression.create(train, target='label',
                                  **self.param)
...
def binary_classification_integer_target(cls):
    ...
    cls.model = tc.boosted_trees_classifier.create(cls.dtrain,
                                         target=cls.target,
...
class BoostedTreesClassifierTest(unittest.TestCase):
    ...
    def test_create(self):
        model =tc.boosted_trees_classifier.create(self.dtrain, target='label',
                                        validation_set=self.dtest,
                                        **self.param)
        ...
        dtrain['label'] = 10
        self.assertRaises(ToolkitError,
                          lambda: tc.boosted_trees_classifier.create(self.dtrain,
                            target='label_wrong', **self.param))
    ...
    def _test_classifier_model(self, train, test, accuracy_threshold, target='label'):
        # create
        model = tc.boosted_trees_classifier.create(train, target=target,
                                        validation_set=test,
                                        **self.param)
        # predict
