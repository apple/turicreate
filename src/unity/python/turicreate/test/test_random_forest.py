...
class RandomForestRegressionTest(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.model = tc.random_forest_regression.create(self.dtrain,
                                             target=self.target,
    ...
    def test_create(self):
        model =tc.random_forest_regression.create(self.dtrain, target='label',
                                        validation_set=self.dtest,
                                        **self.param)
        ...
        self.assertRaises(ToolkitError,
                          lambda:tc.random_forest_regression.create(self.dtrain,
    ...
    def _test_regression_model(self, train, test, rmse_threshold, target='label'):
        # create
        model = tc.random_forest_regression.create(train, target=target,
                                        validation_set=test,
                                        **self.param)
        # predict
    ...
    def test_predict_new_dictionary_key(self):
        ...
        model = tc.random_forest_regression.create(train, target='label',
                                  **self.param)
        # Act.
...
def binary_classification_integer_target(cls):
    ...
    cls.model = tc.random_forest_classifier.create(cls.dtrain,
                                         target=cls.target,
...
class RandomForestClassifierTest(unittest.TestCase):
    ...
    def test_create(self):
        model =tc.random_forest_classifier.create(self.dtrain, target='label',
                                        validation_set=self.dtest,
                                        **self.param)
        ...
        dtrain['label'] = 10
        self.assertRaises(ToolkitError,
                          lambda: tc.random_forest_classifier.create(self.dtrain,
                            target='label_wrong', **self.param))
    ...
    def _test_classifier_model(self, train, test, accuracy_threshold, target='label'):
        # create
        model = tc.random_forest_classifier.create(train, target=target,
                                        validation_set=test,
                                        **self.param)
        # predict
    ...
    def test_predict_new_dictionary_key(self):
        ...
        model = tc.random_forest_classifier.create(train, target='label',
                                  **self.param)
        # Act.
        y1 = model.predict(test)
        y2 = model.predict(list(test))
