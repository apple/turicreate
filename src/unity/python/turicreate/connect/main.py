...
ENGINE_START_ERROR_MESSAGE = 'Cannot connect to turicreate engine. ' + \
    'If you believe this to be a bug, check https://github.com/apple/turicreate/issues for known issues.'
