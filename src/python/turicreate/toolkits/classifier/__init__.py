...
svm_classifier = _LazyModuleLoader(_mod_par + 'svm_classifier')
logistic_classifier = _LazyModuleLoader(_mod_par + 'logistic_classifier')
boosted_trees_classifier = _LazyModuleLoader(_mod_par + 'boosted_trees_classifier')
nearest_neighbor_classifier = _LazyModuleLoader(_mod_par + 'nearest_neighbor_classifier')
random_forest_classifier = _LazyModuleLoader(_mod_par + 'random_forest_classifier')
decision_tree = _LazyModuleLoader(_mod_par + 'decision_tree')