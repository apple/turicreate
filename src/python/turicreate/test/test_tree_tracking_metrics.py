...
class TreeRegressionTrackingMetricsTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.models = {'bst': tc.regression.boosted_trees_regression,
    ...
    def test_tracking_metrics_consistency(self):
        ...
        for ntrees in [1, 2, 3]:
            m = self.models['rf'].create(self.train, 'target', validation_set=self.test, max_iterations=ntrees, metric=self.test_metrics,
                                         random_seed=1)
            rf_models.append(m)
...
class BinaryTreeClassifierTrackingMetricsTest(TreeRegressionTrackingMetricsTest):
    ...
    def setUpClass(cls):
        ...
        cls.models = {'bst': tc.classifier.boosted_trees_classifier,
