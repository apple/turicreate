...
class DrawingClassifierTest(unittest.TestCase):
    ...
    @pytest.mark.xfail("Coming soon in a later PR")
    ...
    @pytest.mark.xfail("Coming soon: Waiting on PR #2533")
    ...
    @pytest.mark.xfail("test_export_coreml_with_predict(...) covers this functionality and more")
    ...
    @pytest.mark.xfail("Coming soon: Need to test and debug export_to_coreml")
