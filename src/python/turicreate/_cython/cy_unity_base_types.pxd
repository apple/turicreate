...
cdef extern from "<core/unity/api/unity_sframe_interface.hpp>" namespace "turi":
    cdef cppclass unity_sframe_base:
        pass

cdef extern from "<core/unity/api/unity_sarray_interface.hpp>" namespace "turi":
    cdef cppclass unity_sarray_base:
        pass

cdef extern from "<core/unity/api/unity_graph_interface.hpp>" namespace "turi":
    cdef cppclass unity_sgraph_base:
        pass

cdef extern from "<core/unity/api/unity_sketch_interface.hpp>" namespace "turi":
    cdef cppclass unity_sketch_base:
        pass

cdef extern from "<core/model_server/model_base/model_base.hpp>" namespace "turi":
    cdef cppclass model_base:
        pass

cdef extern from "<core/unity/api/unity_global_interface.hpp>" namespace "turi":
    cdef cppclass unity_global_base:
        pass

cdef extern from "<core/unity/api/unity_sarray_builder_interface.hpp>" namespace "turi":
    cdef cppclass unity_sarray_builder_base:
        pass

cdef extern from "<core/unity/api/unity_sframe_builder_interface.hpp>" namespace "turi":
