...
cdef extern from "<core/unity/unity_global.hpp>" namespace "turi":
...
cdef extern from "<core/unity/unity_global_singleton.hpp>" namespace "turi":
...
cdef extern from "<core/unity/api/function_closure_info.hpp>" namespace "turi":
...
cdef extern from "<core/unity/api/client_base_types.hpp>" namespace "turi":
