...
if __name__ == '__main__':
    ...
    # Currently, as a hack, the make_wheel script generates a version 
    # with the tensorflow above removed by sed.  This means there's an empty
    # entry in there, so this hopefully takes care of that. 
